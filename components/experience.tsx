    ...
    <section id="experience" className="py-24 relative">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto relative">
          {/* Timeline line — runs down the left */}
          <div className="absolute left-6 top-0 bottom-0 w-px bg-gradient-to-b from-cyan via-violet to-indigo" />
          ...
          {experiences.map((exp, index) => (
            ...
            >
              {/* Timeline dot */}
              <div className="absolute left-6 top-8 -translate-x-1/2 w-4 h-4 rounded-full bg-gradient-to-br from-cyan to-violet z-10">
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-cyan to-violet animate-ping opacity-30" />
              </div>

              {/* Card — full width of remaining space */}
              <div className="glass-card rounded-2xl p-6 md:p-8 group hover:border-cyan/30 transition-all relative overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan/20 to-violet/20 flex items-center justify-center shrink-0">
                ...
                {/* Description — now has full card width to breathe */}
